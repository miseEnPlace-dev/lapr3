...
public class Basket {
    ...
    public Basket(HashMap<Product, Integer> ordered, HashMap<Producer, HashMap<Product, Integer>> received, Enterprise hub, Client client) throws InvalidOrderException, InvalidHubException{
        setOrdered(ordered);
