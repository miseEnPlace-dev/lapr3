...
public interface Graph<V, E> extends Cloneable {
   ...
   *
   * @return all the vertices of the graph as an ArrayList. Each vertex is in its
   *         key position in the ArrayList.
   */
  ...
  /**
   * Adds a new edge between two vertices. If the vertices are not already in the
   ...
   * @return true if an edge between vOrig and vDest was present in the graph,
   *         false otherwise
   */
