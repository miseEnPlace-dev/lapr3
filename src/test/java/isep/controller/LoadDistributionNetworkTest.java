...
public class LoadDistributionNetworkTest {
  ...
  public void testLoadDistributionNetworkFromSampleFile() {
    ...
    assertEquals(network.getDistanceBetweenDirectedConnected(ct7, ct2), 63448);
    assertEquals(network.getDistanceBetweenDirectedConnected(ct7, ct6), 67584);
    assertEquals(network.getDistanceBetweenDirectedConnected(ct9, ct5), 62655);
  }
  ...
  public void testLoadDistributionNetworkIsBidirectional() {
    ...
    assertEquals(network.getDistanceBetweenDirectedConnected(ct7, ct2), network.getDistanceBetweenDirectedConnected(ct2, ct7));
  }
}
