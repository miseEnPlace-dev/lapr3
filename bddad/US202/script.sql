...
ALTER TABLE FatorProducaoSubstancia ADD CONSTRAINT FKFatorProdu760304 FOREIGN KEY (id_substancia) REFERENCES Substancia (id_substancia) ON DELETE CASCADE;
ALTER TABLE FatorProducaoSubstancia ADD CONSTRAINT FKFatorProdu994771 FOREIGN KEY (id_fator_producao) REFERENCES FatorProducao (id_fator_producao) ON DELETE CASCADE;
ALTER TABLE FatorProducao ADD CONSTRAINT FKFatorProdu929110 FOREIGN KEY (id_tipo_fator_producao) REFERENCES TipoFatorProducao (id_tipo_fator_producao) ON DELETE CASCADE;
ALTER TABLE FatorProducao ADD CONSTRAINT FKFatorProdu745587 FOREIGN KEY (id_tipo_formulacao) REFERENCES TipoFormulacao (id_tipo_formulacao) ON DELETE CASCADE;
ALTER TABLE Cultura ADD CONSTRAINT FKCultura145286 FOREIGN KEY (id_tipo_cultura) REFERENCES TipoCultura (id_tipo_cultura) ON DELETE CASCADE;
ALTER TABLE PlanoRega ADD CONSTRAINT FKPlanoRega644835 FOREIGN KEY (id_setor) REFERENCES Setor (id_setor) ON DELETE CASCADE;
ALTER TABLE PlanoRega ADD CONSTRAINT FKPlanoRega105418 FOREIGN KEY (id_tipo_rega) REFERENCES TipoRega (id_tpo_rega) ON DELETE CASCADE;
ALTER TABLE TipoRega ADD CONSTRAINT FKTipoRega396109 FOREIGN KEY (id_tipo_tubagem) REFERENCES TipoTubagem (id_tipo_tubagem) ON DELETE CASCADE;
ALTER TABLE Sensor ADD CONSTRAINT FKSensor979466 FOREIGN KEY (id_tipo_sensor) REFERENCES TipoSensor (id_tipo_sensor) ON DELETE CASCADE;
ALTER TABLE Cultura ADD CONSTRAINT FKCultura72246 FOREIGN KEY (id_produto) REFERENCES Produto (id_produto) ON DELETE CASCADE;
ALTER TABLE ProdutoEncomenda ADD CONSTRAINT FKProdutoEnc708380 FOREIGN KEY (id_produto) REFERENCES Produto (id_produto) ON DELETE CASCADE;
ALTER TABLE Cliente ADD CONSTRAINT FKCliente206820 FOREIGN KEY (cod_postal_entrega) REFERENCES Localidade (cod_postal) ON DELETE CASCADE;
ALTER TABLE Produto ADD CONSTRAINT FKProduto445137 FOREIGN KEY (id_escalao_iva) REFERENCES EscalaoIva (id_escalao_iva) ON DELETE CASCADE;
ALTER TABLE MedicaoSensor ADD CONSTRAINT FKMedicaoSen844882 FOREIGN KEY (id_sensor) REFERENCES Sensor (id_sensor) ON DELETE CASCADE;
ALTER TABLE MedicaoSensor ADD CONSTRAINT FKMedicaoSen825065 FOREIGN KEY (id_setor) REFERENCES Setor (id_setor) ON DELETE CASCADE;
ALTER TABLE Rega ADD CONSTRAINT FKRega852702 FOREIGN KEY (id_tipo_rega) REFERENCES TipoRega (id_tpo_rega) ON DELETE CASCADE;
ALTER TABLE Rega ADD CONSTRAINT FKRega392120 FOREIGN KEY (id_setor) REFERENCES Setor (id_setor) ON DELETE CASCADE;
ALTER TABLE Colheita ADD CONSTRAINT FKColheita890158 FOREIGN KEY (id_produto) REFERENCES Produto (id_produto) ON DELETE CASCADE;
ALTER TABLE Colheita ADD CONSTRAINT FKColheita958985 FOREIGN KEY (id_setor) REFERENCES Setor (id_setor); ON DELETE CASCADE
ALTER TABLE ProdutoEncomenda ADD CONSTRAINT FKProdutoEnc488678 FOREIGN KEY (id_encomenda) REFERENCES Encomenda (id_encomenda) ON DELETE CASCADE;
ALTER TABLE Encomenda ADD CONSTRAINT FKEncomenda598842 FOREIGN KEY (id_cliente) REFERENCES Cliente (id_cliente); ON DELETE CASCADE
ALTER TABLE Plantacao ADD CONSTRAINT FKPlantacao582454 FOREIGN KEY (id_setor) REFERENCES Setor (id_setor) ON DELETE CASCADE;
ALTER TABLE Plantacao ADD CONSTRAINT FKPlantacao141907 FOREIGN KEY (id_cultura) REFERENCES Cultura (id_cultura) ON DELETE CASCADE;
ALTER TABLE Cliente ADD CONSTRAINT FKCliente909904 FOREIGN KEY (cod_postal) REFERENCES Localidade (cod_postal) ON DELETE CASCADE;
ALTER TABLE Edificio ADD CONSTRAINT FKEdificio810117 FOREIGN KEY (id_tipo_edificio) REFERENCES TipoEdificio (id_tipo_edificio) ON DELETE CASCADE;
ALTER TABLE AplicacaoFatorProducao ADD CONSTRAINT FKAplicacaoF489632 FOREIGN KEY (id_setor) REFERENCES Setor (id_setor) ON DELETE CASCADE;
ALTER TABLE AplicacaoFatorProducao ADD CONSTRAINT FKAplicacaoF82233 FOREIGN KEY (id_fator_producao) REFERENCES FatorProducao (id_fator_producao) ON DELETE CASCADE;
ALTER TABLE AplicacaoFatorProducao ADD CONSTRAINT FKAplicacaoF203895 FOREIGN KEY (id_tipo_aplicacao_fator_producao) REFERENCES TipoAplicacaoFatorProducao (id_tipo_aplicacao_fator_producao) ON DELETE CASCADE;
ALTER TABLE Encomenda ADD CONSTRAINT FKEncomenda991394 FOREIGN KEY (cod_postal_entrega) REFERENCES Localidade (cod_postal) ON DELETE CASCADE;
