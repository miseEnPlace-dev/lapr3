...
-- FALHA
INSERT INTO TipoCultura (id_tipo_cultura,tipo_cultura) VALUES (999,'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'); -- FALHA
...
-- FALHA
INSERT INTO Substancia (id_substancia,substancia) VALUES (999,'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'); -- FALHA

-- TipoFormulacao (verificaçao de restriçoes)
INSERT INTO TipoFormulacao (id_tipo_formulacao,tipo_formulacao) VALUES (NULL,NULL);
-- FALHA
INSERT INTO TipoFormulacao (id_tipo_formulacao,tipo_formulacao) VALUES (999,'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'); -- FALHA
...
INSERT INTO FatorProducaoSubstancia (id_fator_producao,id_substancia,quantidade) VALUES (NULL,NULL,NULL);
-- FALHA (teste prova restricoes)
INSERT INTO FatorProducaoSubstancia (id_fator_producao,id_substancia,quantidade) VALUES (999,999,9999);
-- FALHA (teste prova restricoes)

-- TipoTubagem (verificaçao de restriçoes)
INSERT INTO TipoTubagem (id_tipo_tubagem,tipo_tubagem) VALUES (NULL,NULL);
-- FALHA (teste prova restricoes)
INSERT INTO TipoTubagem (id_tipo_tubagem,tipo_tubagem) VALUES (999,'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'); -- FALHA (teste prova restricoes)

-- TipoRega (verificaçao de restriçoes)
INSERT INTO TipoRega (id_tipo_rega,id_tipo_tubagem) VALUES (NULL,NULL); -- FALHA (teste prova restricoes)
INSERT INTO TipoRega (id_tipo_rega,id_tipo_tubagem) VALUES (999,12345678910); -- FALHA (teste prova restricoes)

-- PlanoRega (verificaçao de restriçoes)
INSERT INTO PlanoRega (id_setor,data_inicio_tempo_periocidade,id_tipo_rega,data_fim) VALUES (NULL,NULL,NULL,NULL,NULL,NULL);
-- FALHA (teste prova restricoes)
INSERT INTO PlanoRega (id_setor,data_inicio_tempo_periocidade,id_tipo_rega,data_fim) VALUES (12345678910,'20171-01-01',12345678910,'201712-01-01',999);
-- FALHA (teste prova restricoes)
...
INSERT INTO ProdutoEncomenda (id_encomenda,id_produto,quantidade,preco_unitario,iva,designacao_produto) VALUES (NULL,NULL,NULL,NULL,NULL);
-- FALHA (teste prova restricoes)
...
INSERT INTO Plantacao (id_produto,id_setor,data_inicio) VALUES (NULL,NULL,NULL);
-- FALHA (teste prova restricoes)
INSERT INTO Plantacao (id_produto,id_setor,data_inicio) VALUES (123456789101S,123,'2017');
-- FALHA (teste prova restricoes)
...
INSERT INTO AplicacaoFatorProducao (id_setor,id_fator_proucao,data,id_tipo_aplicacao_fator_producao) VALUES (NULL,NULL,NULL,NULL);
-- FALHA (teste prova restricoes)
INSERT INTO AplicacaoFatorProducao (id_setor,id_fator_proucao,data,id_tipo_aplicacao_fator_producao) VALUES (12345678910,12345678910,'2017',9999);
-- FALHA (teste prova restricoes)

-- ProdutoCultura (verificacao de restricoes)
INSERT INTO ProdutoCultura (id_produto,id_cultura) VALUES (NULL,NULL);
-- FALHA (teste prova restricoes)
INSERT INTO ProdutoCultura (id_produto,id_cultura) VALUES (12345678910,12345678910);
-- FALHA (teste prova restricoes)
