...
BEGIN
  ...
  id_cultura1 := gestao_setores.fn_RegistarCultura('Cultura 4', id_setor1);
  id_cultura2 := gestao_setores.fn_RegistarCultura('Cultura 5', id_setor2);
  id_cultura3 := gestao_setores.fn_RegistarCultura('Cultura 1', id_setor3);
