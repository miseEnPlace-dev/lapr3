...
int main(void)
{
  ...
  printf("\n");
  print_result(vel_wind, NUM_VEL_WIND_REGISTERS, "Velocidade do Vento", "km/h");
  printf("\n");
  print_result(dir_wind, NUM_DIR_WIND_REGISTERS, "Direção do Vento", "º");
  printf("\n");
  print_result(pluvio, NUM_PLUVIO_REGISTERS, "Pluviosidade", "mm");
  printf("\n");
  print_result(soil_humidity, NUM_SOIL_HUMIDITY_REGISTERS, "Humidade do Solo", "%");
  printf("\n");
  print_result(air_humidity, NUM_AIR_HUMIDITY_REGISTERS, "Humidade do Ar", "%");
